  ...
  const services = [
    {
      ...
      description:
        "At Lead Time, we are a y was founded with the vision of revolutionizing the advertising catching displays.",
    },
    {
          ...
          <SwiperSlide key={index}>
            <div className="bg-white rounded-lg overflow-hidden shadow-lg">
              ...
              <div className="p-6 bg-[#222220] text-white ">
                <h3 className="text-[1.5rem] leading-[32px] tracking-[1px] font-[500] mb-2">
                  {service.title}
                </h3>
                <p className="text-[#FFFFFFCC] text-[1.125rem] leading-[26px] tracking-[1px] mb-4">
                  {service.description}
                </p>
