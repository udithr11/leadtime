...
const Footer = () => {
  ...
  Let’s have a <TextAnimation firstText="chat!" secondText="chat!" />
    ...
    <img src={logo} alt="Leadtime Advertising LLC" className="max-w-full mb-8 w-[13.143rem]" />
    <p className="font-normal text-base leading-7 tracking-[0.07rem] text-[#FFFFFFCC] pr-[6rem]">
      Guiding you through the nuances of emotional sales, transform your professional goals into achievements with expert ease and insight.
    </p>
  </div>
    ...
    <h3 className="font-medium text-[1.5rem] leading-8 tracking-[0.15rem] mb-8">Contact Us</h3>
    <p className="mb-2 font-normal text-base leading-7 tracking-[0.07rem] text-[#FFFFFFCC]">+91 9645013281</p>
    <p className="mb-2 font-normal text-base leading-7 tracking-[0.07rem] text-[#FFFFFFCC]">+91 8654200154</p>
    <p className="font-normal text-base leading-7 tracking-[0.07rem] text-[#FFFFFFCC]">Leadtime@gmail.com</p>
  </div>
